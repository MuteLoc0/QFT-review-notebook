...
费曼传播子
\begin{align*}
   D_{ij}= D_F(x-y)= \bra{0} T \phi(x)\phi(y) \ket{0} = \int \frac{\dif^4 p}{(2\pi)^4} \frac{\ramuno}{p^2 - m^2 + \ramuno\epsilon} \eu^{-\ramuno p \cdot (x-y)} 
...
\nsection{散射问题汇总}
\concept{散射截面Cross Section}{$\sigma \equiv \frac{}$}
